...
import myFooter from './footer.jpeg'; // Import gif from the images folder
    ...
    <IconButton color="inherit">
      ...
      <Box
        sx={{
          ...
          paddingTop: '64px', // Offset the height of the fixed navbar
          paddingBottom: '56px', // Offset for the footer height
        }}
      >
